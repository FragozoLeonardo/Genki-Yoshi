    ...
    (1..rows).each do |row|
      ...
      (1..cols).each do |col|
        ...
        if col == 1 && input_index < kanji_kana_size
          ...
          text_width = pdf.width_of(first_char, size: 48)
          text_x = top_left[0] + (cell_size - text_width) / 2
          text_y = top_left[1] - (cell_size * 0.80)
          pdf.draw_text first_char, at: [text_x, text_y], size: 48
        elsif col > 1
...
input_kanji_kana = %w[あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわゐゑをんがぎぐげござじずぜぞだぢづでどばびぶべぼぱぴぷぺぽアイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヰヱヲンガギグゲゴザジズゼゾダヂヅデドバビブベボパピプペポ日月火水木金土曜一二三四五六七八九十百千万半数円分時週年今初始終何回台度代点番倍上下右左前後午以所中間横東西南北山川池海田野林森地島洋世界図形表大小多少高安低広太早近遠新古良悪私父母子兄弟姉妹親族男女夫妻主奥人者友民員達朝昼夕夜晩毎先次予定立歩走登止駐入出去起寝乗降忙急座泳泣家校窓門館室部屋堂院工場店社駅寺庭園行来帰発着送通進運落食飲肉茶油酒菜飯料理味切目口耳鼻顔頭首手足体力元気病生死薬医休言話申交見聞読書知忘使調計自転車船動具電品荷物紙服有名便利不同長短重強弱重軽速遅開占押引拾捨持洗作取国際特京都道府県市区町村内合遊禁失正神祭化本映画旅写真] 
